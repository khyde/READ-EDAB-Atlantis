...
; ****************************************************************************************************
  ...
  FOR D=0, N_ELEMENTS(DATASETS)-1 DO BEGIN
    ...
    IF KEYWORD_SET(DAILY_COMPARE) THEN BEGIN
      BUFFER=1
      PLTPROD='CHLOR_A' & YRANGE=[0,3]
      DATERANGES = ['1997','1998','1999','2018']
      PERIODS = ['D']
      SHAPES = ['NES_EPU_NOESTUARIES'];,SHPFILE]
      PRODS = ['PSC_'+['MICRO']+'-TURNER'];,'CHLOR_A-CCI'] ; ,'NANO','PICO','PSC_FDIATOM-HIRATA']
      VCOMBOS = LIST(['4.2','5.0','6.0','6.0S'],['6.0','6.0S']); LIST(['4.2','5.0'],['4.2','6.0'],['5.0','6.0'],['4.2','5.0','6.0'])
          ...
          FOR C=0, N_ELEMENTS(VCOMBOS)-1 DO BEGIN
            ...
            FOR V=0, N_ELEMENTS(VCMB)-1 DO BEGIN
              CASE VCMB[V] OF
                ...
                '5.0': CMBS = [CMBS,'OCCCI,V5.0,STACKED_SAVE,'+PROD5+', ']
